/*
  ...
  - Added the required column `authorType` to the `posts` table without a default value. This is not possible if the table is not empty.
...
ADD COLUMN     "authorType" VARCHAR(50) NOT NULL,
